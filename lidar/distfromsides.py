...
"""
    ...
    dist_x = dist_mm*c
    dist_y = dist_mm*s
    print "angle %d dist_tot %d quality%d" % (angle,lidarData[angle][0],lidarData[angle][1])
        ...
        #bad = 2
    #else:
        #if (angle >= 166 and angle <=194):
            #current_angle = angle
        #elif (angle >= 346 or angle <= 15):
            #dfright(angle,dist_x)
        #else:
            #x =1
